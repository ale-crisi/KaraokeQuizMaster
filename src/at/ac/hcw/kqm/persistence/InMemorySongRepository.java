...
public class InMemorySongRepository implements SongRepository {
    ...
    private void initializeSongs() {
        ...
        songs.add(new Song(1, "Bohemian Rhapsody", "Queen", true));
        songs.add(new Song(2, "Shape of You", "Ed Sheeran", true));
        songs.add(new Song(3, "Billie Jean", "Michael Jackson", true));
