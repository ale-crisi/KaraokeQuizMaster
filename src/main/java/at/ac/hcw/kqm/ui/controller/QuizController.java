...
public class QuizController {
    ...
    private void loadQuestion() {
        // Check if game is actually finished before trying to load
        ...
        try {
            ...
            // If we still get an exception despite checking isGameFinished,
            // it means the game state is inconsistent - force to result
            SceneManager.get().showResult();
        }
    }
